    ...
    fun trackLocation(): Flow<Location> {
        return callbackFlow {
            ...
            val request = LocationRequest.Builder(1000)
                .setPriority(Priority.PRIORITY_HIGH_ACCURACY) // 🔥 Ajout de la haute précision
                .setIntervalMillis(1000) // Assure une mise à jour chaque seconde
                .setMinUpdateIntervalMillis(500) // Délai minimal entre deux updates
                .build()
