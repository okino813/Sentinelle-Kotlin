...
class HomeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (ContextCompat.checkSelfPermission(requireContext(), android.Manifest.permission.ACCESS_BACKGROUND_LOCATION)
            == PackageManager.PERMISSION_GRANTED) {
            // Permission accordée
        } else {
            requestPermissions(arrayOf(android.Manifest.permission.ACCESS_BACKGROUND_LOCATION), REQUEST_CODE_BACKGROUND_LOCATION)
        }
                ...
                if (response.isSuccessful) {
                    ...
                    requireActivity().runOnUiThread {
                        ...
                        if (NewToken != "null") {
                            ...
                            val sharedPreferences = requireContext().getSharedPreferences("app_state", MODE_PRIVATE)
